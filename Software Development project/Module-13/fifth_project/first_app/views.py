...
def DjangoForm(request):
    # it will give html file but we want to see value
    # form=contactForm()
    # print(form)

    # it will show us the value(best approach in views.py)
    if request.method == 'POST':
        form=contactForm(request.POST , request.FILES)
        if form.is_valid():
            # file=form.cleaned_data['file']
            # # to show my file in   upload folder...sob jate acept korte pare tai wb+ dilam
