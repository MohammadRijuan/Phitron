    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            if sender_account.balance < amount:
                ...
                send_transaction_email(request.user, amount, "Transfer Confirmation", "transactions/transfer_email.html")
                send_transaction_email(receiver_account.user, amount, "Transfer Received", "transactions/transfer_email.html")
