                ...
                div.innerHTML = `
                    <div class="card m-2 text-center" style="width: 20rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p><small class="category-style "><a>${product.category}</a></small></p>
...
const displaySingleProduct = (product) => {
    ...
    <main class="col-lg-6">
      <div class="ps-lg-3">
        ...
        <a href="#" class="btn btn-primary shadow-0"> <i class="me-1"></i> Add to cart </a>
        <a href="#" class="btn btn-light border border-info py-2 icon-hover px-3"> <i class="me-1"></i> Save </a>
        </div>
